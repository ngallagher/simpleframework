/*
 * BufferWrapper.java February 2008
 *
...
/**
 * The <code>BufferWrapper</code> object represents a packet that wraps 
 * an unmodifiable buffer. This ensures that the contents of the buffer
 ...
 */
class BufferWrapper implements Packet {
   ...
   /**
    * Constructor for the <code>BufferWrapper</code> object. This 
    * will create a wrapper for the provided buffer which will enable 
    ...
    * @param buffer this is the buffer that is to be wrapped
    * @param sequence this is the sequence number for this packet
    * @param shared this determines if the packet is shared
    */
   ...
   private Packet extract(int size) throws IOException {
      ...
      return new BufferWrapper(data, sequence, false);
   }
