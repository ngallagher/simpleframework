...
public class TransportSender implements Sender {
    ...
    */    
   public synchronized void send(byte[] array) throws IOException {
    ...
    */    
   public synchronized void send(byte[] array, int off, int len) throws IOException {
    ...
    * @param len this is the number of bytes that are to be sent
    */    
   public synchronized void send(ByteBuffer buffer, int off, int len) throws IOException {
      int mark = buffer.position();
