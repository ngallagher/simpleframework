/*
 * SessionMonitor.java February 2014
 *
 ...
 * 
 * @see org.simpleframework.http.socket.service.SessionChecker
 */
class SessionMonitor implements FrameListener {
    ...
    */
   public SessionMonitor(SessionChecker checker) {
