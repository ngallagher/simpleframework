/*
 * ContainerSocketConnector.java February 2001
 *
...
/**
 * The <code>ContainerSocketConnector</code> object is a connector
 ...
 */
public class ContainerSocketConnector implements SocketConnector {
    ...
    */
   private final SocketConnector adapter;  

   /**
    * Constructor for the <code>ContainerSocketConnector</code> object. 
    ...
    */
   public ContainerSocketConnector(Container container) throws IOException {
      this(container, 8);
   }
    ...
    */
   public ContainerSocketConnector(Container container, int count) throws IOException {
      this(container, count, 1);
   }
   
   /**
    * Constructor for the <code>ContainerSocketConnector</code> object. The
    ...
    */
   public ContainerSocketConnector(Container container, int count, int select) throws IOException {
    ...
    */   
   public ContainerSocketConnector(Container container, Allocator allocator) throws IOException {
    ...
    * @param count this is the number of threads used for each pool
    */   
   public ContainerSocketConnector(Container container, Allocator allocator, int count) throws IOException {
    ...
    * @param select this is the number of selector threads to use
    */   
   public ContainerSocketConnector(Container container, Allocator allocator, int count, int select) throws IOException {
     this.connector = new ContainerTransportConnector(container, allocator, count, select);
     this.adapter = new TransportSocketConnector(connector, count); 
   }  
