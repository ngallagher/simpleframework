/*
 * TransportConnector.java February 2007
 *
...
/**
 * This is the <code>TransportConnector</code> used to connect the
 * provided transport to a higher layer. It is the responsibility of
...
public interface TransportConnector {
   ...
   /**
    * This is used to connect a <code>Transport</code> instance to
    ...
    */
   void connect(Transport transport) throws IOException;
   
   /**
    * This method is used to stop the <code>TransportConnector</code> 
