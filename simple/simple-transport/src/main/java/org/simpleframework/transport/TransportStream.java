/*
 * TransportStream.java February 2007
 *
...
/**
 * The <code>TransportStream</code> object represents a cursor that
 ...
 */
class TransportStream implements Stream {
   ...
   /**
    * Constructor for the <code>TransportStream</code> object. This
    ...
    */
   public TransportStream(Transport transport) {
      this(transport, 2048);
   }
    ...
    */   
   public TransportStream(Transport transport, int size) {
