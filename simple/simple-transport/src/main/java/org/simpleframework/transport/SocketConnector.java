/*
 * SocketConnector.java February 2001
 *
...
/**
 * The <code>SocketConnector</code> interface represents a connector that 
...
public interface SocketConnector {
   ...
   /**
    * This method is used to stop the <code>SocketConnector</code> such 
