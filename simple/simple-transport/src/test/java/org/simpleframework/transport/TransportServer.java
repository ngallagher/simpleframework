   ...
   public static void main(String[] list) throws Exception {
      ...
      TransportProcessor processor = new TransportProcessor() {
         public void process(Transport transport) throws IOException{
            ...
            System.err.println(Thread.currentThread().getName() + ": " + transport.getChannel() + " --> "+ engine);
            transport.close();
         }
      ...
      TransportSocketProcessor engine = new TransportSocketProcessor(processor);
      SocketConnection connection = new SocketConnection(engine);
